...
extension NetFX45MscorlibTests {
    @Test func testTypeMethodEnumeration() throws {
        let equalityComparer = try #require(assembly.resolveTypeDefinition(fullName: "System.Collections.Generic.EqualityComparer`1"))
        #expect(try equalityComparer.methods.map({ $0.name }).sorted() == [ "Equals", "GetHashCode" ])
    }

    @Test func testMethodClass() throws {
        let object = try #require(assembly.resolveTypeDefinition(fullName: "System.Object"))
    ...
    @Test func testMethodFlags() throws {
        ...
        let iasyncResult_get_IsCompleted = try #require(assembly.resolveTypeDefinition(fullName: "System.IAsyncResult")?
        ...
        // Static method
        let gc_WaitForPendingFinalizers = try #require(assembly.resolveTypeDefinition(fullName: "System.GC")?
        ...
        let exception_ToString = try #require(assembly.resolveTypeDefinition(fullName: "System.Exception")?
    ...
    @Test func testMethodHasReturnValue() throws {
        ...
        let disposable = try #require(assembly.resolveTypeDefinition(fullName: "System.IDisposable"))
    ...
    @Test func testMethodParamType() throws {
        let string = try #require(assembly.resolveTypeDefinition(fullName: "System.String"))
    ...
    @Test func testParamByRef() throws {
        let guid = try #require(assembly.resolveTypeDefinition(fullName: "System.Guid"))
